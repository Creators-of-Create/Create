...
public class VanillaHatOffsetGenerator extends TrainHatInfoProvider {
	...
	protected void createOffsets() {
		...
		this.makeInfoFor(EntityType.DONKEY, new Vec3(0.0F, -0.8F, 2.0F));
		this.makeInfoFor(EntityType.ELDER_GUARDIAN, new Vec3(0.0F, 20.0F, 0.0F), 0.95F);
		...
		this.makeInfoFor(EntityType.GHAST, new Vec3(0.0F, 6.0F, 0.0F), "body", 0.92F);
		this.makeInfoFor(EntityType.GLOW_SQUID, new Vec3(0.0F, 7.0F, 0.0F), "body", 0.92F);
		this.makeInfoFor(EntityType.GOAT, new Vec3(-0.5F, -8.5F, -9F), "head", 2F);
		this.makeInfoFor(EntityType.GUARDIAN, new Vec3(0.0F, 20.0F, 0.0F), 0.9F);
		this.makeInfoFor(EntityType.HOGLIN, new Vec3(0.0F, 0.0F, -4.5F), 0.5F);
		this.makeInfoFor(EntityType.HORSE, new Vec3(0.0F, -0.8F, 2.0F));
		...
		this.makeInfoFor(EntityType.MULE, new Vec3(0.0F, -0.8F, 2.0F));
		...
		this.makeInfoFor(EntityType.PIGLIN, new Vec3(0.0F, 0.0F, 0.0F), 0.92F);
		this.makeInfoFor(EntityType.PIGLIN_BRUTE, new Vec3(0.0F, 0.0F, 0.0F), 0.92F);
		...
		this.makeInfoFor(EntityType.SHEEP, new Vec3(0.0F, 0.4F, -1.0F), 0.87F);
		this.makeInfoFor(EntityType.SILVERFISH, new Vec3(0.0F, 3.0F, 0.0F), "segment1");
		this.makeInfoFor(EntityType.SKELETON_HORSE, new Vec3(0.0F, -0.8F, 2.0F));
		...
		this.makeInfoFor(EntityType.SNOW_GOLEM, new Vec3(0.0F, -0.2F, 0.0F), 0.82F);
		this.makeInfoFor(EntityType.SPIDER, new Vec3(0.0F, 2.0F, -3.5F));
		this.makeInfoFor(EntityType.SQUID, new Vec3(0.0F, 7.0F, 0.0F), "body", 0.92F);
		this.makeInfoFor(EntityType.STRIDER, new Vec3(0.0F, 8.0F, 0.0F), "body", 0.95F);
		...
		this.makeInfoFor(EntityType.WARDEN, new Vec3(0.0F, 0F, 0.5F), "bone/body/head", 0.9F);
		this.makeInfoFor(EntityType.WITCH, new Vec3(0.0F, -1.8F, 0.0F), 1F);
		...
		this.makeInfoFor(EntityType.ZOMBIE_HORSE, new Vec3(0.0F, -0.8F, 2.0F));
		this.makeInfoFor(EntityType.ZOMBIFIED_PIGLIN, new Vec3(0.0F, 0.0F, 0.0F), 0.92F);
	}
}
