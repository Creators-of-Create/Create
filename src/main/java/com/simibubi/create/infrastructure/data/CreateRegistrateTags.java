...
public class CreateRegistrateTags {
	...
	private static void genItemTags(RegistrateTagsProvider<Item> provIn) {
		...
		TagGen.addOptional(prov.tag(AllItemTags.UPRIGHT_ON_BELT.tag), Mods.AET, List.of("skyroot_remedy_bucket", "skyroot_poison_bucket"));

		TagGen.addOptional(prov.tag(AllItemTags.UPRIGHT_ON_BELT.tag), Mods.D_AET, List.of("poison_bucket"));

		TagGen.addOptional(prov.tag(AllItemTags.UPRIGHT_ON_BELT.tag), Mods.AET_R, List.of("oatmeal"));
	}
