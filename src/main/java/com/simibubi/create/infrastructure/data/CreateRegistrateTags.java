...
public class CreateRegistrateTags {
	...
	private static void genItemTags(RegistrateTagsProvider<Item> provIn) {
		...
		TagGen.addOptional(prov.tag(AllItemTags.UPRIGHT_ON_BELT.tag), Mods.UG, List.of("virulent_mix_bucket",
			"bloody_stew", "inky_stew", "indigo_stew", "veilew_stew", "slop_bowl"));

		TagGen.addOptional(prov.tag(AllItemTags.UPRIGHT_ON_BELT.tag), Mods.UUE, List.of(
			"warped_potion", "warped_infusion", "chorus_juice", "chorus_tea", "ender_stew", "blob_stew"));

		TagGen.addOptional(prov.tag(AllItemTags.UPRIGHT_ON_BELT.tag), Mods.Q, List.of(
			"bottled_cloud"));
	}
