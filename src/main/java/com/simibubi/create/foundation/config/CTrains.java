...
public class CTrains extends ConfigBase {
	...
	public final ConfigInt maxTrackPlacementDistance = i(32, 0, "maxTrackPlacementDistance", Comments.maxTrackPlacementDistance);
	...
	private static class Comments {
		...
		static String maxTrackPlacementDistance = "Maximum distance from the player at which a Rail can be placed in creative. (capped by render distance)";
	}
