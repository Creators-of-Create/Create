...
public class BaseConfigScreen extends ConfigScreen {
	...
	protected void init() {
		...
		TextStencilElement clientText = new TextStencilElement(font, Component.literal(clientTile)).centered(true, true);
		...
		TextStencilElement commonText = new TextStencilElement(font, Component.literal(commonTile)).centered(true, true);
		...
		TextStencilElement serverText = new TextStencilElement(font, Component.literal(serverTile)).centered(true, true);
