...
import com.simibubi.create.lib.mixin.common.accessor.ClientboundPlayerAbilitiesPacketAccessor;
...
//		 packet.setFlySpeed(speed);
		((ClientboundPlayerAbilitiesPacketAccessor) packet).create$setFlyingSpeed(speed);
