...
import com.simibubi.create.foundation.ponder.content.CartAssemblerScenes;
import com.simibubi.create.foundation.ponder.content.ChainDriveScenes;
import com.simibubi.create.foundation.ponder.content.ChassisScenes;
import com.simibubi.create.foundation.ponder.content.ChuteScenes;
import com.simibubi.create.foundation.ponder.content.CrafterScenes;
import com.simibubi.create.foundation.ponder.content.DeployerScenes;
import com.simibubi.create.foundation.ponder.content.DisplayScenes;
import com.simibubi.create.foundation.ponder.content.EjectorScenes;
import com.simibubi.create.foundation.ponder.content.FanScenes;
import com.simibubi.create.foundation.ponder.content.FunnelScenes;
import com.simibubi.create.foundation.ponder.content.GantryScenes;
import com.simibubi.create.foundation.ponder.content.ItemVaultScenes;
import com.simibubi.create.foundation.ponder.content.KineticsScenes;
import com.simibubi.create.foundation.ponder.content.MechanicalDrillScenes;
import com.simibubi.create.foundation.ponder.content.MechanicalSawScenes;
import com.simibubi.create.foundation.ponder.content.MovementActorScenes;
import com.simibubi.create.foundation.ponder.content.PistonScenes;
import com.simibubi.create.foundation.ponder.content.ProcessingScenes;
import com.simibubi.create.foundation.ponder.content.PulleyScenes;
import com.simibubi.create.foundation.ponder.content.RedstoneScenes;
import com.simibubi.create.foundation.ponder.content.RedstoneScenes2;
import com.simibubi.create.foundation.ponder.content.SteamScenes;
import com.simibubi.create.foundation.ponder.content.TunnelScenes;
...
public class CreatePonderIndex {
	...
	public static void register() {
		...
		HELPER.forComponents(AllBlocks.SHAFT)
			.addStoryBoard("shaft/relay", KineticsScenes::shaftAsRelay, CreatePonderTag.KINETIC_RELAYS);
		...
		HELPER.forComponents(AllBlocks.COGWHEEL)
			.addStoryBoard("cog/small", KineticsScenes::cogAsRelay, CreatePonderTag.KINETIC_RELAYS)
		...
		HELPER.forComponents(AllBlocks.LARGE_COGWHEEL)
			.addStoryBoard("cog/speedup", KineticsScenes::cogsSpeedUp)
			.addStoryBoard("cog/large", KineticsScenes::largeCogAsRelay, CreatePonderTag.KINETIC_RELAYS)
			.addStoryBoard("cog/encasing", KineticsScenes::cogwheelsCanBeEncased);

		HELPER.forComponents(AllItems.BELT_CONNECTOR)
			.addStoryBoard("belt/connect", BeltScenes::beltConnector, CreatePonderTag.KINETIC_RELAYS)
			.addStoryBoard("belt/directions", BeltScenes::directions)
			.addStoryBoard("belt/transport", BeltScenes::transport, CreatePonderTag.LOGISTICS)
		...
		HELPER.forComponents(AllBlocks.GEARBOX, AllItems.VERTICAL_GEARBOX)
			.addStoryBoard("gearbox", KineticsScenes::gearbox, CreatePonderTag.KINETIC_RELAYS);

		HELPER.addStoryBoard(AllBlocks.CLUTCH, "clutch", KineticsScenes::clutch, CreatePonderTag.KINETIC_RELAYS);
		HELPER.addStoryBoard(AllBlocks.GEARSHIFT, "gearshift", KineticsScenes::gearshift, CreatePonderTag.KINETIC_RELAYS);
		...
		HELPER.forComponents(AllBlocks.ENCASED_FAN)
			.addStoryBoard("fan/direction", FanScenes::direction, CreatePonderTag.KINETIC_APPLIANCES)
			.addStoryBoard("fan/processing", FanScenes::processing);

		HELPER.forComponents(AllBlocks.CREATIVE_MOTOR)
			.addStoryBoard("creative_motor", KineticsScenes::creativeMotor, CreatePonderTag.KINETIC_SOURCES)
		...
		HELPER.addStoryBoard(AllBlocks.WATER_WHEEL, "water_wheel", KineticsScenes::waterWheel,
				CreatePonderTag.KINETIC_SOURCES);
		HELPER.addStoryBoard(AllBlocks.HAND_CRANK, "hand_crank", KineticsScenes::handCrank, CreatePonderTag.KINETIC_SOURCES);
		...
		HELPER.addStoryBoard(AllBlocks.ENCASED_CHAIN_DRIVE, "chain_drive/relay", ChainDriveScenes::chainDriveAsRelay,
				CreatePonderTag.KINETIC_RELAYS);
		...
		HELPER.forComponents(AllBlocks.ITEM_VAULT)
			.addStoryBoard("item_vault/storage", ItemVaultScenes::storage, CreatePonderTag.LOGISTICS)
			.addStoryBoard("item_vault/sizes", ItemVaultScenes::sizes);

		// Chutes
		HELPER.forComponents(AllBlocks.CHUTE)
			.addStoryBoard("chute/downward", ChuteScenes::downward, CreatePonderTag.LOGISTICS)
		...
		HELPER.forComponents(AllBlocks.ANDESITE_FUNNEL, AllBlocks.BRASS_FUNNEL)
			.addStoryBoard("funnels/intro", FunnelScenes::intro, CreatePonderTag.LOGISTICS)
		...
		HELPER.forComponents(AllBlocks.LINEAR_CHASSIS, AllBlocks.SECONDARY_LINEAR_CHASSIS)
			.addStoryBoard("chassis/linear_group", ChassisScenes::linearGroup, CreatePonderTag.CONTRAPTION_ASSEMBLY)
			.addStoryBoard("chassis/linear_attachment", ChassisScenes::linearAttachement);
		HELPER.forComponents(AllBlocks.RADIAL_CHASSIS)
			.addStoryBoard("chassis/radial", ChassisScenes::radial, CreatePonderTag.CONTRAPTION_ASSEMBLY);
		HELPER.forComponents(AllItems.SUPER_GLUE)
			.addStoryBoard("super_glue", ChassisScenes::superGlue, CreatePonderTag.CONTRAPTION_ASSEMBLY);
		HELPER.forComponents(AllBlocks.STICKER)
			.addStoryBoard("sticker", RedstoneScenes::sticker, CreatePonderTag.CONTRAPTION_ASSEMBLY);

		// Mechanical Arm
		HELPER.forComponents(AllBlocks.MECHANICAL_ARM)
			.addStoryBoard("mechanical_arm/setup", ArmScenes::setup, CreatePonderTag.ARM_TARGETS)
		...
		HELPER.forComponents(AllBlocks.MECHANICAL_PISTON, AllBlocks.STICKY_MECHANICAL_PISTON)
			.addStoryBoard("mechanical_piston/anchor", PistonScenes::movement, CreatePonderTag.KINETIC_APPLIANCES,
					CreatePonderTag.MOVEMENT_ANCHOR);
		HELPER
		...
		HELPER.forComponents(AllBlocks.ROPE_PULLEY)
			.addStoryBoard("rope_pulley/anchor", PulleyScenes::movement, CreatePonderTag.KINETIC_APPLIANCES,
					CreatePonderTag.MOVEMENT_ANCHOR)
		...
		HELPER.forComponents(AllBlocks.WINDMILL_BEARING)
			.addStoryBoard("windmill_bearing/source", BearingScenes::windmillsAsSource, CreatePonderTag.KINETIC_SOURCES)
		...
		HELPER.forComponents(AllBlocks.MECHANICAL_BEARING)
			.addStoryBoard("mechanical_bearing/anchor", BearingScenes::mechanicalBearing, CreatePonderTag.KINETIC_APPLIANCES,
					CreatePonderTag.MOVEMENT_ANCHOR)
			...
			.addStoryBoard("mechanical_bearing/stabilized", BearingScenes::stabilizedBearings,
					CreatePonderTag.CONTRAPTION_ACTOR);

		// Clockwork Bearing
		HELPER.addStoryBoard(AllBlocks.CLOCKWORK_BEARING, "clockwork_bearing", BearingScenes::clockwork,
				CreatePonderTag.KINETIC_APPLIANCES, CreatePonderTag.MOVEMENT_ANCHOR);
		...
		HELPER.forComponents(AllBlocks.CART_ASSEMBLER)
			.addStoryBoard("cart_assembler/anchor", CartAssemblerScenes::anchor, CreatePonderTag.MOVEMENT_ANCHOR)
		...
		HELPER.forComponents(AllBlocks.PORTABLE_STORAGE_INTERFACE)
			.addStoryBoard("portable_interface/transfer", MovementActorScenes::psiTransfer, CreatePonderTag.CONTRAPTION_ACTOR)
		...
		HELPER.forComponents(AllBlocks.MECHANICAL_SAW)
			.addStoryBoard("mechanical_saw/processing", MechanicalSawScenes::processing, CreatePonderTag.KINETIC_APPLIANCES)
			.addStoryBoard("mechanical_saw/breaker", MechanicalSawScenes::treeCutting)
			.addStoryBoard("mechanical_saw/contraption", MechanicalSawScenes::contraption, CreatePonderTag.CONTRAPTION_ACTOR);
		HELPER.forComponents(AllBlocks.MECHANICAL_DRILL)
			.addStoryBoard("mechanical_drill/breaker", MechanicalDrillScenes::breaker, CreatePonderTag.KINETIC_APPLIANCES)
			.addStoryBoard("mechanical_drill/contraption", MechanicalDrillScenes::contraption,
					CreatePonderTag.CONTRAPTION_ACTOR);
		HELPER.forComponents(AllBlocks.DEPLOYER)
			.addStoryBoard("deployer/filter", DeployerScenes::filter, CreatePonderTag.KINETIC_APPLIANCES)
			...
			.addStoryBoard("deployer/contraption", DeployerScenes::contraption, CreatePonderTag.CONTRAPTION_ACTOR);
		...
		HELPER.forComponents(AllBlocks.FLUID_PIPE)
			.addStoryBoard("fluid_pipe/flow", PipeScenes::flow, CreatePonderTag.FLUIDS)
		...
		HELPER.forComponents(AllBlocks.MECHANICAL_PUMP)
			.addStoryBoard("mechanical_pump/flow", PumpScenes::flow, CreatePonderTag.FLUIDS, CreatePonderTag.KINETIC_APPLIANCES)
			.addStoryBoard("mechanical_pump/speed", PumpScenes::speed);
		HELPER.forComponents(AllBlocks.FLUID_VALVE)
			.addStoryBoard("fluid_valve", PipeScenes::valve, CreatePonderTag.FLUIDS, CreatePonderTag.KINETIC_APPLIANCES);
		HELPER.forComponents(AllBlocks.SMART_FLUID_PIPE)
			.addStoryBoard("smart_pipe", PipeScenes::smart, CreatePonderTag.FLUIDS);
		HELPER.forComponents(AllBlocks.FLUID_TANK)
			.addStoryBoard("fluid_tank/storage", FluidTankScenes::storage, CreatePonderTag.FLUIDS)
			.addStoryBoard("fluid_tank/sizes", FluidTankScenes::sizes);
		HELPER.forComponents(AllBlocks.CREATIVE_FLUID_TANK)
			.addStoryBoard("fluid_tank/storage_creative", FluidTankScenes::creative, CreatePonderTag.FLUIDS,
					CreatePonderTag.CREATIVE)
			.addStoryBoard("fluid_tank/sizes_creative", FluidTankScenes::sizes);
		HELPER.forComponents(AllBlocks.HOSE_PULLEY)
			.addStoryBoard("hose_pulley/intro", HosePulleyScenes::intro, CreatePonderTag.FLUIDS, CreatePonderTag.KINETIC_APPLIANCES)
		...
		HELPER.forComponents(AllBlocks.SPOUT)
			.addStoryBoard("spout", SpoutScenes::filling, CreatePonderTag.FLUIDS);
		HELPER.forComponents(AllBlocks.ITEM_DRAIN)
			.addStoryBoard("item_drain", DrainScenes::emptying, CreatePonderTag.FLUIDS);
		HELPER.forComponents(AllBlocks.PORTABLE_FLUID_INTERFACE)
			.addStoryBoard("portable_interface/transfer_fluid", FluidMovementActorScenes::transfer, CreatePonderTag.FLUIDS,
					CreatePonderTag.CONTRAPTION_ACTOR)
	...
	public static void registerTags() {
		...
		HELPER.addToTag(CreatePonderTag.KINETIC_RELAYS)
			.add(AllBlocks.SHAFT)
		...
		HELPER.addToTag(CreatePonderTag.KINETIC_SOURCES)
		...
		HELPER.addToTag(CreatePonderTag.TRAIN_RELATED)
			.add(AllBlocks.TRACK)
		...
		HELPER.addToTag(CreatePonderTag.KINETIC_APPLIANCES)
		...
		HELPER.addToTag(CreatePonderTag.FLUIDS)
		...
		HELPER.addToTag(CreatePonderTag.ARM_TARGETS)
			.add(AllBlocks.MECHANICAL_ARM)
			.add(AllItems.BELT_CONNECTOR)
			.add(AllBlocks.CHUTE)
			.add(AllBlocks.DEPOT)
		...
		HELPER.addToTag(CreatePonderTag.LOGISTICS)
			.add(AllItems.BELT_CONNECTOR)
			.add(AllItems.FILTER)
		...
		HELPER.addToTag(CreatePonderTag.DECORATION)
		...
		HELPER.addToTag(CreatePonderTag.CREATIVE)
			.add(AllBlocks.CREATIVE_CRATE)
			.add(AllBlocks.CREATIVE_FLUID_TANK)
			.add(AllBlocks.CREATIVE_MOTOR);

		HELPER.addToTag(CreatePonderTag.SAILS)
			.add(AllBlocks.SAIL)
			.add(AllBlocks.SAIL_FRAME)
			.add(Blocks.WHITE_WOOL);

		HELPER.addToTag(CreatePonderTag.REDSTONE)
			.add(AllBlocks.ORANGE_NIXIE_TUBE)
		...
		HELPER.addToTag(CreatePonderTag.MOVEMENT_ANCHOR)
			.add(AllBlocks.MECHANICAL_PISTON)
			.add(AllBlocks.WINDMILL_BEARING)
			.add(AllBlocks.MECHANICAL_BEARING)
			.add(AllBlocks.CLOCKWORK_BEARING)
		...
		HELPER.addToTag(CreatePonderTag.CONTRAPTION_ASSEMBLY)
		...
		HELPER.addToTag(CreatePonderTag.CONTRAPTION_ACTOR)
		...
		HELPER.addToTag(CreatePonderTag.DISPLAY_SOURCES)
			.add(AllBlocks.SEATS.get(DyeColor.WHITE))
			.add(AllBlocks.ORANGE_NIXIE_TUBE)
			.add(AllBlocks.STOCKPILE_SWITCH)
			.add(AllBlocks.CONTENT_OBSERVER)
		...
		HELPER.addToTag(CreatePonderTag.DISPLAY_TARGETS)
			.add(AllBlocks.ORANGE_NIXIE_TUBE)
			.add(AllBlocks.DISPLAY_BOARD)
			.add(AllBlocks.DISPLAY_LINK)
			.add(Blocks.OAK_SIGN)
