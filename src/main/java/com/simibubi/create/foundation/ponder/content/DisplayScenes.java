...
public class DisplayScenes {
	...
	public static void link(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.world.setDisplayBoardText(board, 1,
			Component.literal(1024 + " ").append(Lang.translateDirect("generic.unit.stress")));
		scene.world.flashDisplayLink(linkPos);
		scene.idle(40);
		...
		scene.idle(10);
		scene.world.setDisplayBoardText(board, 1,
			Component.literal("6:00 ").append(Lang.translateDirect("generic.daytime.pm")));
	...
	public static void board(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.idle(6);
		scene.world.setDisplayBoardText(board, 0, Component.literal(""));
		scene.idle(25);
