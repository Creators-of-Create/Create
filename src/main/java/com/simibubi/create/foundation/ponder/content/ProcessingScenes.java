...
public class ProcessingScenes {
	...
	public static void millstone(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.idle(18);
		scene.world.modifyEntity(entity1, entity -> entity.remove(Entity.RemovalReason.DISCARDED));
	...
	public static void emptyBlazeBurner(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.world.modifyEntities(Blaze.class, blaze -> blaze.remove(Entity.RemovalReason.DISCARDED));
		scene.idle(20);
