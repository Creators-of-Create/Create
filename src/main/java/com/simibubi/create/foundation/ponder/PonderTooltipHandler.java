...
public class PonderTooltipHandler {
	...
	private static ITextComponent makeProgressBar(float progress) {
		String localizedName = ponderKeybind().getKeyBinding()
			.getLocalizedName();
		String holdW = Lang
			.createTranslationTextComponent(HOLD_TO_PONDER,
				new StringTextComponent(localizedName).applyTextStyle(TextFormatting.GRAY))
