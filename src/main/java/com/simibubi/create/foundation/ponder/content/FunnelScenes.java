...
public class FunnelScenes {
	...
	public static void intro(SceneBuilder scene, SceneBuildingUtil util) {
		...
		for (int i = 0; i < 4; i++) {
			if (lastItemEntity != null)
				scene.world.modifyEntity(lastItemEntity, e -> e.remove(Entity.RemovalReason.DISCARDED));
			if (i < 3)
	...
	public static void directionality(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.world.modifyEntity(itemLink, e -> e.remove(Entity.RemovalReason.DISCARDED));
