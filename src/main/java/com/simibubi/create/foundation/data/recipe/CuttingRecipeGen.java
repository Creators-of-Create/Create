	...
	ANDESITE_ALLOY = create(I::andesiteAlloy, b -> b.duration(200)
		...
		BWG =
			cuttingCompat(Mods.BWG, "aspen", "baobab", "blue_enchanted", "cika", "cypress", "ebony",
					"fir", "florus", "green_enchanted", "holly", "ironwood", "jacaranda", "mahogany", "mangrove", "maple",
					"palm", "pine", "rainbow_eucalyptus", "redwood", "sakura", "skyris", "white_mangrove",
					"willow", "witch_hazel", "zelkova"),
		BWG_8 = stripAndMakePlanks(Mods.BWG, "palo_verde_log", "stripped_palo_verde_log", null),
		BWG_9 = stripAndMakePlanks(Mods.BWG, "palo_verde_wood", "stripped_palo_verde_wood", null),
