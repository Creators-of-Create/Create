...
public class ChainConveyorRidingHandler {
	...
	public static void clientTick() {
		...
		if (AnimationTickHolder.getTicks() % 10 == 0)
			net.createmod.catnip.api.client.network.ClientNetworkHelper.INSTANCE.sendToServer(new ServerboundChainConveyorRidingPacket(ridingChainConveyor, false));
	}

	private static void stopRiding() {
		if (ridingChainConveyor != null)
			net.createmod.catnip.api.client.network.ClientNetworkHelper.INSTANCE.sendToServer(new ServerboundChainConveyorRidingPacket(ridingChainConveyor, true));
