...
@OnlyIn(Dist.CLIENT)
public class UnstickyGlueRenderer extends EntityRenderer<UnstickyGlueEntity> {

	private ResourceLocation regular = new ResourceLocation(Create.ID, "textures/entity/unsticky_glue/slime.png");
	...
	public UnstickyGlueRenderer(EntityRendererManager renderManager) {
		super(renderManager);
		initQuads();
	}

	@Override
	public ResourceLocation getEntityTexture(UnstickyGlueEntity entity) {
		return regular;
	}

	@Override
	public void render(UnstickyGlueEntity entity, float p_225623_2_, float p_225623_3_, MatrixStack ms,
		...
		boolean holdingGlue = AllItems.UNSTICKY_GLUE.isIn(player.getHeldItemMainhand())
			|| AllItems.UNSTICKY_GLUE.isIn(player.getHeldItemOffhand());
	...
	private int getBrightnessForRender(UnstickyGlueEntity entity) {
