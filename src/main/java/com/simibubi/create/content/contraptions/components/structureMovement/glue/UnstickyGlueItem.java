...
public class UnstickyGlueItem extends Item {

	public UnstickyGlueItem(Properties properties) {
		super(properties);
	}
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		UnstickyGlueEntity entity = new UnstickyGlueEntity(world, blockpos1, direction);
		...
		itemstack.damageItem(1, playerentity, UnstickyGlueItem::onBroken);
	...
	public static void spawnParticles(World world, BlockPos pos, Direction direction, boolean fullBlock) {
		...
		ItemStack stack = new ItemStack(Items.BLUE_DYE);
