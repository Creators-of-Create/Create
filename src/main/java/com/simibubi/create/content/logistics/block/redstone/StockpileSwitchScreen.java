...
public class StockpileSwitchScreen extends AbstractSimiScreen {
	...
	private final Component invertSignal = CreateLang.translateDirect("gui.stockpile_switch.invert_signal");
	...
	public StockpileSwitchScreen(StockpileSwitchTileEntity te) {
		super(CreateLang.translateDirect("gui.stockpile_switch.title"));
	...
	protected void renderWindow(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		sprite.bind();
		blit(ms, (int) (x + upperBound) + 37, y + 18, (int) (sprite.getStartX() + upperBound), sprite.getStartY(),
			(int) (sprite.getWidth() - upperBound), sprite.getHeight());
		blit(ms, x + 37, y + 40, sprite.getStartX(), sprite.getStartY(), (int) (lowerBound), sprite.getHeight());
