package com.simibubi.create.content.logistics.trains.management.schedule.condition.skip;
...
import com.simibubi.create.content.logistics.trains.management.schedule.condition.wait.CargoThresholdCondition;
...
public class TimeOfDaySkipCondition extends ScheduleSkipCondition {
    ...
    public boolean tickCompletion(Level level, Train train, CompoundTag context) {
        ...
        System.out.println("dayTime: " + dayTime + " targetTicks: " + targetTicks + " diff: " + diff);
